#!/bin/bash
# jenkins_agent.sh.tpl — UserData cho Spot instance tự join Jenkins làm agent
# Terraform templatefile() inject: jenkins_region, worker_iam_profile
# Credentials đọc từ SSM (không hardcode trong template)
...
# Credentials không bao giờ hardcode — đọc từ SSM tại runtime
